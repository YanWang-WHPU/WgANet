...
FOLDER = "/private/workspace/data/" # Replace with your "/path/to/the/ISPRS/dataset/folder/"
    ...
    def __getitem__(self, i):
        ...
        if random_idx in self.data_cache_.keys():
            ...
            ## Vaihingen IRRG
                ...
                ## Vaihingen IRRG
                data = io.imread(self.data_files[random_idx]) # 从文件中读取数据
                data = 1 / 255 * np.asarray(data.transpose((2, 0, 1)), dtype='float32') #归一化
            if self.cache: # 是否启用缓存cache
                self.data_cache_[random_idx] = data # 将数据添加到缓存中
